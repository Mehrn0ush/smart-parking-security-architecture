...
class PackageTests(unittest.TestCase):
    ...
    def test_cyclonedx_scaffolds_generate_and_verify(self) -> None:
        ...
        self.assertEqual(manifest["schema_version"], "13.0")
        ...
        self.assertEqual(manifest["governance_summary"]["review_blocking_count"], 4)
        self.assertEqual(manifest["governance_summary"]["overdue_review_count"], 5)
        self.assertEqual(manifest["governance_summary"]["escalation_required_count"], 5)
        ...
        self.assertEqual(manifest["governance_summary"]["approval_expiring_soon_count"], 1)
        self.assertEqual(manifest["governance_summary"]["dual_review_pending_count"], 3)
        ...
        self.assertEqual(manifest["waiver_owner_action_count"], 1)
        self.assertEqual(manifest["attention_now_count"], 6)
        self.assertEqual(manifest["attention_now_by_category"]["approval_expired_now"], 2)
        self.assertEqual(manifest["attention_now_by_category"]["dual_review_pending"], 3)
        self.assertEqual(manifest["artifact_type_action_count"], 7)
        self.assertEqual(manifest["artifact_type_action_summary"]["cbom"]["dual_review_pending"], 2)
        self.assertEqual(manifest["artifact_type_action_summary"]["sbom"]["blocked_awaiting_approval"], 1)
        self.assertEqual(manifest["trust_boundary_item_count"], 9)
        self.assertEqual(manifest["trust_boundary_summary"]["identity"], 1)
        self.assertEqual(manifest["trust_boundary_summary"]["secrets"], 4)
        self.assertEqual(manifest["trust_boundary_summary"]["cyber_physical_control"], 1)
        self.assertEqual(manifest["trust_boundary_summary"]["ai_ml_provenance_sensitive"], 3)
        self.assertEqual(manifest["governance_summary"]["by_artifact_type"]["sbom"], 6)
        self.assertEqual(manifest["governance_summary"]["by_artifact_type_approval_state"]["cbom"]["expiring_soon"], 1)
        self.assertEqual(manifest["governance_summary"]["by_artifact_type_evidence_support"]["vex"]["verified"], 2)
        self.assertEqual(manifest["governance_summary"]["by_evidence_support_state"]["verified"], 5)
        self.assertEqual(manifest["governance_summary"]["by_approval_presence_state"]["present"], 3)
        self.assertEqual(manifest["governance_summary"]["by_waiver_owner"]["identity-security-board"], 1)
        ...
        self.assertEqual(by_name["Gateway Service"]["artifacts"]["sbom"]["evidence_support_state"], "verified")
        ...
        self.assertEqual(by_name["Gateway Service"]["artifacts"]["sbom"]["approval_presence_state"], "present")
        ...
        self.assertEqual(by_name["Gateway Service"]["artifacts"]["sbom"]["approval_validity_days"], 14)
        self.assertFalse(by_name["Gateway Service"]["artifacts"]["sbom"]["secondary_signoff_present"])
        ...
        self.assertEqual(by_name["Gateway Service"]["artifacts"]["cbom"]["evidence_support_state"], "verified")
        self.assertEqual(by_name["Gateway Service"]["artifacts"]["cbom"]["freshness_state"], "fresh")
        self.assertEqual(by_name["Gateway Service"]["artifacts"]["cbom"]["approval_presence_state"], "present")
        self.assertEqual(
        ...
        self.assertEqual(by_name["Edge AI Runtime"]["provenance"]["evidence_support_state"], "verified")
        ...
        self.assertEqual(by_name["Edge AI Runtime"]["provenance"]["approval_presence_state"], "present")
        ...
        self.assertEqual(by_name["Identity Provider"]["artifacts"]["cbom"]["evidence_support_state"], "none")
        ...
        self.assertEqual(by_name["Secrets Manager"]["artifacts"]["vex"]["evidence_support_state"], "verified")
        ...
        self.assertEqual(by_name["Gateway Service"]["artifacts"]["cbom"]["approval_state"], "expiring_soon")
        self.assertEqual(by_name["Gateway Service"]["artifacts"]["cbom"]["approval_validity_days"], 21)
        self.assertTrue(by_name["Gateway Service"]["artifacts"]["cbom"]["dual_review_required"])
        self.assertTrue(by_name["Gateway Service"]["artifacts"]["cbom"]["dual_review_satisfied"])
        self.assertTrue(by_name["Gateway Service"]["artifacts"]["cbom"]["secondary_signoff_present"])
        ...
        artifact_type_actions_md = ROOT / "bom" / "artifact-type-actions.md"
        waiver_summary_md = ROOT / "bom" / "waiver-summary.md"
        attention_now_md = ROOT / "bom" / "attention-now.md"
        trust_boundary_summary_md = ROOT / "bom" / "trust-boundary-summary.md"
        ...
        self.assertTrue(artifact_type_actions_md.exists())
        self.assertTrue(waiver_summary_md.exists())
        self.assertTrue(attention_now_md.exists())
        self.assertTrue(trust_boundary_summary_md.exists())
        ...
        self.assertEqual(gateway_sbom_selected["evidence_support_state"], "verified")
        ...
        self.assertEqual(gateway_sbom_selected["approval_presence_state"], "present")
        ...
        self.assertEqual(gateway_sbom_selected["approval_validity_days"], "14")
        self.assertEqual(gateway_sbom_selected["dual_review_required"], "false")
        self.assertEqual(gateway_sbom_selected["secondary_signoff_present"], "false")
        ...
        self.assertEqual(gateway_cbom_selected["evidence_support_state"], "verified")
        self.assertEqual(gateway_cbom_selected["derived_maturity_state"], "partially_evidenced")
        self.assertEqual(gateway_cbom_selected["approval_state"], "expiring_soon")
        self.assertEqual(gateway_cbom_selected["approval_presence_state"], "present")
        self.assertEqual(gateway_cbom_selected["approval_validity_days"], "21")
        self.assertEqual(gateway_cbom_selected["dual_review_required"], "true")
        self.assertEqual(gateway_cbom_selected["dual_review_satisfied"], "true")
        self.assertEqual(gateway_cbom_selected["secondary_signoff_present"], "true")
        self.assertEqual(gateway_cbom_selected["escalation_status"], "not-required")
        ...
        self.assertEqual(edge_ai_model_provenance["binding_state"], "linked")
        self.assertEqual(edge_ai_model_provenance["evidence_support_state"], "verified")
        ...
        self.assertEqual(edge_ai_model_provenance["approval_presence_state"], "present")
        self.assertEqual(edge_ai_model_provenance["approval_validity_days"], "14")
        ...
        self.assertEqual(edge_ai_model_provenance["secondary_signoff_present"], "false")
        self.assertEqual(
        ...
        self.assertEqual(identity_provider_cbom["evidence_support_state"], "none")
        ...
        self.assertEqual(secrets_manager_vex["evidence_support_state"], "verified")
        ...
        self.assertEqual(component_properties["smartparking.evidence_support_state"], "verified")
        ...
        self.assertEqual(component_properties["smartparking.approval_presence_state"], "present")
        ...
        self.assertEqual(component_properties["smartparking.approval_validity_days"], "14")
        self.assertEqual(component_properties["smartparking.dual_review_required"], "false")
        self.assertEqual(component_properties["smartparking.secondary_signoff_present"], "false")
        ...
        self.assertEqual(cbom_properties["smartparking.evidence_support_state"], "verified")
        ...
        self.assertEqual(cbom_properties["smartparking.approval_state"], "expiring_soon")
        self.assertEqual(cbom_properties["smartparking.approval_validity_days"], "21")
        self.assertEqual(cbom_properties["smartparking.dual_review_satisfied"], "true")
        self.assertEqual(cbom_properties["smartparking.secondary_signoff_present"], "true")
        ...
        reviewer_actions_text = reviewer_actions_md.read_text()
        self.assertIn("blocked_awaiting_approval", reviewer_actions_text)
        self.assertIn("approval_expired", reviewer_actions_text)
        self.assertIn("dual_review_pending", reviewer_actions_text)
        self.assertIn("waiver_expiring_soon", reviewer_actions_text)
        self.assertIn("review_overdue", reviewer_actions_text)

        artifact_type_actions_text = artifact_type_actions_md.read_text()
        self.assertIn("# Artifact-Type Action Summary", artifact_type_actions_text)
        self.assertIn("## sbom", artifact_type_actions_text)
        self.assertIn("## cbom", artifact_type_actions_text)
        self.assertIn("Gateway Service", artifact_type_actions_text)

        waiver_summary_text = waiver_summary_md.read_text()
        self.assertIn("identity-security-board", waiver_summary_text)
        self.assertIn("Identity Provider / cbom", waiver_summary_text)

        attention_now_text = attention_now_md.read_text()
        self.assertIn("approval_expired_now", attention_now_text)
        self.assertIn("low_assurance_ai_provenance", attention_now_text)
        self.assertIn("stale_trust_boundary", attention_now_text)

        trust_boundary_text = trust_boundary_summary_md.read_text()
        self.assertIn("# Trust-Boundary Summary", trust_boundary_text)
        self.assertIn("## identity", trust_boundary_text)
        self.assertIn("## secrets", trust_boundary_text)
        self.assertIn("## cyber_physical_control", trust_boundary_text)
        self.assertIn("## ai_ml_provenance_sensitive", trust_boundary_text)
